...
import { checkAdmin, updateRooms, clearErrors } from "redux/actions/adminAction";
...
const EditRoom = () => {
    ...
    const { success, loading, message } = useSelector(state => state.updateRooms);
    const {
        register,
        handleSubmit,
        formState: { errors },
        ...
        defaultValues: {
            ...
            guest: room.guestCapacity ? room.guestCapacity : "",
            baths: room.numOfBaths ? room.numOfBaths : "",
            beds: room.numOfBeds ? room.numOfBeds : "",
            internet: room.internet ? room.internet : null,
            breakfast: room.breakFast ? room.breakFast : null,
            airCondition: room.airConditioned ? room.airConditioned : null,
            petAllowed: room.petsAllowed ? room.petsAllowed : null,
            roomCleaning: room.roomCleaning ? room.roomCleaning : null,
        },
    });
    ...
    const onSubmit = (data, e) => {
        dispatch(updateRooms(data, Router.query.index))
    };
    useEffect(() => {
        if (!success) {
            if (message) {
            ...
            <Box variant="UploadFormContainer">
                ...
                <Box as="form" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Flex>
                        ...
                        >
                            {loading ?
                                <Image sx={styles.Loading} src={Loader} alt="Loading" /> : "Update Room"
                            }
                        </Button>
